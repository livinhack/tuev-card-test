...
import { localize } from "./src/translations/index.js?v=b27";
import { normalizeCardConfig } from "./src/card/config.js?v=b27";
import { findFirstTuevEntity } from "./src/card/entities.js?v=b27";
import { getAllEntityIdsFromConfig, getEntitySections } from "./src/card/groups.js?v=b27";
import { calculateAutomaticBadgeSize, calculateLayoutInfo } from "./src/card/layout.js?v=b27";
import { getSharedPlateLayout } from "./src/card/plate-layout.js?v=b27";
import { CONFIRM_TIMING, getEntityUiState, resetEntityUiStateAfterError, startEntityConfirmation } from "./src/card/ui-state.js?v=b27";
import {
    ...
    renderVehicleHeader
} from "./src/card/render-parts.js?v=b27";
import {
    ...
    isPlateFontLoaded,
    renderLicensePlate
} from "./src/plate/renderer.js?v=b27";
import { TuevCardEditor } from "./src/editor/editor.js?v=b27";
