...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b45`.
...
```yaml
url: /hacsfiles/tuev-card/tuev-card.js?v=b45
type: module
```
...
2. Change the package version to `0.1.1-b45`.
3. Adjust the bundle release label to `b45`.
4. Run:
