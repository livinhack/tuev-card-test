...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b57`.
...
2. Change the package version to `0.1.1-b57`.
3. Adjust the bundle release label to `b57`.
4. Run:
