...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b48`.
...
```yaml
url: /hacsfiles/tuev-card/tuev-card.js?v=b48
type: module
```
...
2. Change the package version to `0.1.1-b48`.
3. Adjust the bundle release label to `b48`.
4. Run:
