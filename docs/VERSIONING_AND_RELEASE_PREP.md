...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b51`.
...
```yaml
url: /hacsfiles/tuev-card/tuev-card.js?v=b51
type: module
```
...
2. Change the package version to `0.1.1-b51`.
3. Adjust the bundle release label to `b51`.
4. Run:
