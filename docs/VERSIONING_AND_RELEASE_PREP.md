...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b56`.
...
2. Change the package version to `0.1.1-b56`.
3. Adjust the bundle release label to `b56`.
4. Run:
