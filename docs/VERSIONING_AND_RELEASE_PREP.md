...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b52`.
...
```yaml
url: /hacsfiles/tuev-card/tuev-card.js?v=b52
type: module
```
...
2. Change the package version to `0.1.1-b52`.
3. Adjust the bundle release label to `b52`.
4. Run:
