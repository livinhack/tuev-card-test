...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b44`.
...
2. Change the package version to `0.1.1-b44`.
3. Adjust the bundle release label to `b44`.
4. Run:
