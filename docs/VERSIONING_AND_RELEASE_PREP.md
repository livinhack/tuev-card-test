...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b54`.
...
```yaml
url: /hacsfiles/tuev-card/tuev-card.js?v=b54
type: module
```
...
2. Change the package version to `0.1.1-b54`.
3. Adjust the bundle release label to `b54`.
4. Run:
