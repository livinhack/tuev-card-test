# TÜV Card b46 release notes

Current checked version: `b46`.

This document records the first semantic test release milestone. `b46` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b46`.
...
- Confirm the package version is `0.1.1-b46`.
- Confirm the generated bundle header says `TÜV Card bundled b46`.
...
## Explicitly deferred until after b46
...
1. Copy this `b46` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b46`.
4. Use the release title `b46 - Initial test release`.
