# TÜV Card b57 release notes

Current checked version: `b57`.

This document records the first semantic test release milestone. `b57` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b57`.
...
- Confirm the package version is `0.1.1-b57`.
- Confirm the generated bundle header says `TÜV Card bundled b57`.
...
## Explicitly deferred until after b57
...
1. Copy this `b57` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b57`.
4. Use the release title `b57 - Initial test release`.
