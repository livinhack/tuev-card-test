# TÜV Card b49 release notes

Current checked version: `b49`.

This document records the first semantic test release milestone. `b49` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b49`.
...
- Confirm the package version is `0.1.1-b49`.
- Confirm the generated bundle header says `TÜV Card bundled b49`.
...
## Explicitly deferred until after b49
...
1. Copy this `b49` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b49`.
4. Use the release title `b49 - Initial test release`.
