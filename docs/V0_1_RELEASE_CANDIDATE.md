# TÜV Card b47 release notes

Current checked version: `b47`.

This document records the first semantic test release milestone. `b47` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b47`.
...
- Confirm the package version is `0.1.1-b47`.
- Confirm the generated bundle header says `TÜV Card bundled b47`.
...
## Explicitly deferred until after b47
...
1. Copy this `b47` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b47`.
4. Use the release title `b47 - Initial test release`.
