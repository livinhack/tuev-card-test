# TÜV Card b50 release notes

Current checked version: `b50`.

This document records the first semantic test release milestone. `b50` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b50`.
...
- Confirm the package version is `0.1.1-b50`.
- Confirm the generated bundle header says `TÜV Card bundled b50`.
...
## Explicitly deferred until after b50
...
1. Copy this `b50` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b50`.
4. Use the release title `b50 - Initial test release`.
