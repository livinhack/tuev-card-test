# TÜV Card b51 release notes

Current checked version: `b51`.

This document records the first semantic test release milestone. `b51` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b51`.
...
- Confirm the package version is `0.1.1-b51`.
- Confirm the generated bundle header says `TÜV Card bundled b51`.
...
## Explicitly deferred until after b51
...
1. Copy this `b51` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b51`.
4. Use the release title `b51 - Initial test release`.
