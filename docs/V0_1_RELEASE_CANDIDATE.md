# TÜV Card b56 release notes

Current checked version: `b56`.

This document records the first semantic test release milestone. `b56` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b56`.
...
- Confirm the package version is `0.1.1-b56`.
- Confirm the generated bundle header says `TÜV Card bundled b56`.
...
## Explicitly deferred until after b56
...
1. Copy this `b56` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b56`.
4. Use the release title `b56 - Initial test release`.
