...
`b52` is the first semantic test release. It is based on the confirmed release-candidate and repository-cleanup checkpoints and should not introduce new runtime behavior compared with the tested candidate state.
...
```text
/local/community/tuev-card/tuev-card.js?v=b52
```
...
/hacsfiles/tuev-card/tuev-card.js?v=b52
```
...
## b52 handoff checkpoint

See `docs/B50_HANDOFF_CHECKPOINT.md` for the 50-version continuation checkpoint.


## b52 compact confirm overlay

See `docs/B51_FIXED_SIZE_CONFIRM_OVERLAY.md`.
